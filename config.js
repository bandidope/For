...
global.owner = [
  [ '51936994155', 'Whois Yallico 🤖', true ],
  [ '51904937048', 'Bot Oficial 🤖', true ]
]

global.mods = []
global.prems = []

global.packname = `[ 𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞 🤖`
global.author = '𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞 🤖]'
global.stickpack = '© 𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞 🤖'
global.stickauth = '𝘽𝙮 𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞 '
global.wm = '𝙉𝙤𝙭 🤖'
global.botname = '[ 𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞  𝙈𝘿 🤖 ]'
global.textbot = `Powered Team Nightwish 🌀`
global.dev = '• 𝙋ο𝙬𝙚𝙧𝙚𝙙 𝙗𝙮 𝘾ο𝙢𝙢𝙪𝙣𝙞𝙩𝙮 𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞 🤖'
global.wait = '🌪️ *𝘼𝙜𝙪𝙖𝙧𝙙𝙚 𝙪𝙣 𝙢ο𝙢𝙚𝙣𝙩ο, 𝙨ο𝙮 𝙡𝙚𝙣𝙩ο... ฅ^•ﻌ•^ฅ\n\n> 𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞 🤖 🌪️*'
global.listo = '*𝘼𝙦𝙪𝙞 𝙩𝙞𝙚𝙣𝙚 ฅ^•ﻌ•^ฅ*'
global.namechannel = '𝐅𝐨𝐫 𝐓𝐡𝐫𝐞𝐞 🤖'
...
global.insta = 'https://www.insta.com/whois.yallico'
